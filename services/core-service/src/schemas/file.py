...
class FileBase(BaseModel):
    ...
    user_id: Optional[int] = Field(None, description="ID of the user who uploaded the file")
...
class FileUpdate(BaseModel):
    ...
    user_id: Optional[int] = Field(None, description="New ID of the user who uploaded the file")
...
class FileListResponse(BaseModel):
    count: int = Field(description="Total number of files associated with the resume")
    # limit: Optional[int] = Field(None, description="The number of items per page")
    # offset: Optional[int] = Field(None, description="The offset of the current page")
    list: List[FileResponse] = Field(description="List of file objects")